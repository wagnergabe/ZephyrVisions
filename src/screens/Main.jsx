...
const Main = () => {
  ...
  <h1 className="sr-only">
    Zephyr Visions – Professional Drone Services in Minnesota
  </h1>
          ...
          <section className="relative w-full bg-gradient-to-r from-neutral-950 via-neutral-900 to-neutral-950 text-white text-center py-12 my-12 shadow-2xl overflow-hidden border-y border-[#07C0EA]/50">
            <div className="animate-fade-in px-6">
              ...
              <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                <span className="font-semibold text-white">Zephyr Visions</span>{" "}
                proudly earned the
                <span className="font-semibold text-[#07C0EA]">
                  {" "}
                ...
                <span className="font-semibold text-[#07C0EA]">
                  {" "}
                  New Hope “In Focus” Photo Contest
                </span>{" "}
        ...
        <section className="lg:w-[75%] mt-16 px-6">
          <h2 className="text-5xl text-center text-[#07C0EA] font-bold">
            Services
          </h2>
          ...
          <ul className="flex flex-wrap justify-center gap-10 my-16 mx-3 text-center">
            <li className="flex flex-col items-center max-w-xs">
              ...
              <p className="text-sm mt-2">
                Artistic aerial photography and videos for property listings,
            ...
            <li className="flex flex-col items-center max-w-xs">
              ...
              <p className="text-sm mt-2">
                High-resolution imagery and cinematic video for any purpose.
              </p>
            </li>
            ...
            <li className="flex flex-col items-center max-w-xs">
              ...
              <p className="text-sm mt-2">
                Progress tracking, documentation, and aerial perspectives for
                job sites.
              </p>
            </li>
            ...
            <li className="flex flex-col items-center max-w-xs">
              ...
              <p className="text-sm mt-2">
                FLIR Level 1 sUAS Certified Thermographer offering infrared
                inspections for roofs, solar panels, and infrastructure
                anomalies.
              </p>
            </li>
            ...
            <li className="flex flex-col items-center max-w-xs">
              ...
              <p className="text-sm mt-2">
                Orthomosaics, terrain models, and interactive site
                visualization.
              </p>
            </li>
            ...
            <li className="flex flex-col items-center max-w-xs">
              ...
              <p className="text-sm mt-2">
                Immersive indoor videos for businesses, showrooms, and
                warehouses.
              </p>
            </li>
            ...
            <li className="flex flex-col items-center max-w-xs">
              ...
              <p className="text-sm mt-2">
                Capture outdoor events from the sky with dynamic aerial shots.
              </p>
            </li>
            ...
            <li className="flex flex-col items-center max-w-xs">
              ...
              <p className="text-sm mt-2">
                Close-up aerial inspections for assessments and maintenance
                planning.
              </p>
            </li>
          </ul>
        ...
        <div className="flex flex-col items-center justify-center w-full bg-black text-white p-6 my-16">
          ...
          <p className="text-lg text-gray-300 max-w-3xl text-center mb-6">
            <span className="font-semibold">Certified Thermographer</span>{" "}
            through FLIR, providing advanced aerial infrared imaging to detect
            heat signatures, locate anomalies, and deliver actionable insights
            in low-visibility or complex environments.
          </p>
          ...
          <div className="mt-8 max-w-4xl text-center">
            ...
            <ul className="text-gray-300 space-y-2 text-left">
              <li>
                <span className="font-semibold">Heat Signature Detection</span>{" "}
                – Identify hotspots in buildings, electrical grids, and
                vehicles.
              </li>
              <li>
                <span className="font-semibold">Structural Inspections</span> –
                Detect water leaks, insulation gaps, and energy loss.
              </li>
              <li>
                <span className="font-semibold">Search & Rescue</span> – Locate
                missing persons in low-visibility conditions.
              </li>
              <li>
                <span className="font-semibold">
                  Construction & Infrastructure Monitoring
                </span>{" "}
                – Analyze material stress points and overheating.
              </li>
              <li>
                <span className="font-semibold">
                  Agriculture & Wildlife Management
                </span>{" "}
                – Monitor crop health, irrigation, and livestock body
                temperatures.
              </li>
            </ul>
          </div>
        ...
        <section className="w-full bg-white py-20 px-6 flex flex-col items-center">
          <h2 className="text-5xl font-bold text-[#07C0EA] text-center mb-6">
            3D Mapping & Graphics
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl text-center mb-12">
            Capture environments in rich 3D detail — perfect for construction,
            inspections, land surveys, and marketing visuals.
          </p>
        ...
        <section className="max-w-4xl mx-auto px-6 py-16 text-gray-800">
          ...
          <p className="text-lg leading-relaxed mb-6 text-center">
            Aerial photography enhances your sales and marketing efforts by
            providing fresh perspectives, elevating your brand’s image, and
            ensuring you stand out both online and offline.
          </p>

          <p className="text-lg leading-relaxed mb-8 text-center">
            Whether you’re looking to generate buzz on social media or close
            property deals faster, drone photography helps you make a lasting
            impression.
          </p>
