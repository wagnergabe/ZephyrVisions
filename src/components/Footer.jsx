    ...
    return (
        <footer class="bg-[#58595B] h-[60vh] w-full m-0 flex flex-col lg:flex-row justify-evenly items-center">
            ...
            <ul class="flex lg:flex-row flex-col">
                <li><a href="https://www.instagram.com/zvdrones/"><AiOutlineInstagram size={70} color="#07C0EA" /></a></li>
                <li><a href="https://www.instagram.com/zvdrones/"><AiOutlineFacebook size={70} color="#07C0EA" /></a></li>

                <li><a href="youtuve.com"><AiOutlineYoutube size={70} color="#07C0EA"/></a></li>
            </ul>
